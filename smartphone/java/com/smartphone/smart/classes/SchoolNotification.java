...
public class SchoolNotification implements Parcelable {
    ...
    private User target_student;
    private Class target_class;
    private Subject subject;

    public SchoolNotification(Long id, String type, User owner, String title, String description, Date date, Date timestamp, User target_student, Class target_class, Subject subject) {
        this.id = id;
        this.type = type;
        this.owner = owner;
        this.title = title;
    ...
    public SchoolNotification(JSONObject notif) {
        try {
            ...
            if (!notif.isNull("target_student")) {
                student = new User((JSONObject) notif.get("target_student"));
            }
    ...
    protected SchoolNotification(Parcel in) {
        ...
        date = tmpTimestamp != -1 ? new Date(tmpTimestamp) : null;
        target_student = (User) in.readValue(User.class.getClassLoader());
