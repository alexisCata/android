...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.NotificationsViewHolder> {
    ...
    private Boolean absences = false;
    ...
    public NotificationsAdapter(ArrayList<SchoolNotification> notifications, Resources resources, ListItemClickListener listener, Boolean absence) {
        mNotifications = notifications;
        mOnClickListener = listener;
        typeNotifications = eventsType(resources);
        absences = absence;
    ...
    public NotificationsViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (absences)
            layoutIdForListItem = R.layout.notification_list_student_item;
        else
            layoutIdForListItem = R.layout.notification_list_item;
...
//        holder.mNotificationDescription.setText(mNotifications.get(position).getDescription());
        ...
        if (holder.mNotificationClass != null){
            holder.mNotificationClass.setText(mNotifications.get(position).getTarget_class().toString());
            if (mNotifications.get(position).getTarget_student().getId() != null){
                holder.separator.setText("-");
                holder.mNotificationStudent.setText(mNotifications.get(position).getTarget_student().toString());
            }
        }
    ...
    class NotificationsViewHolder extends RecyclerView.ViewHolder
        ...
        TextView mNotificationClass;
        TextView separator;
        TextView mNotificationStudent;
...
//            mNotificationDescription = (TextView) itemView.findViewById(R.id.tv_notif_description);
            if (!absences) {
                mNotificationClass = (TextView) itemView.findViewById(R.id.tv_notif_class);
                separator = (TextView) itemView.findViewById(R.id.tv_label_separator);
                mNotificationStudent = (TextView) itemView.findViewById(R.id.tv_notif_student);
            }
