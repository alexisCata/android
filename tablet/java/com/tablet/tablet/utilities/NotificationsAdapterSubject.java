...
public class NotificationsAdapterSubject extends RecyclerView.Adapter<NotificationsAdapterSubject.NotificationsViewHolder> {
    ...
    public NotificationsAdapterSubject(ArrayList<SchoolNotification> notifications, Resources resources) {
        mNotifications = notifications;
        typeNotifications = eventsType(resources);
    }

    public NotificationsAdapterSubject(ArrayList<SchoolNotification> notifications, Resources resources, ListItemClickListener listener) {
        mNotifications = notifications;
    ...
    public NotificationsViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int layoutIdForListItem = R.layout.notification_list_item_subject;
    ...
    class NotificationsViewHolder extends RecyclerView.ViewHolder
         ...
         *                 {@link NotificationsAdapterSubject#onCreateViewHolder(ViewGroup, int)}
         */
